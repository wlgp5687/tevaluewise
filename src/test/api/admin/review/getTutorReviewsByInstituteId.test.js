...
const getTutorReviewsByInstituteIdTest = () => {
	// 리뷰 질문 및 답변 조회
	describe('GET /v1/admins/reviews/institute/:institute_id/tutor-reviews', () => {
		...
		test('should return invalid status if review_id is not number', (done) => {
			...
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews`)
				.set(setData)
				.expect(500, done);
		});
		...
		test('should return invalid status if review_id is blank', (done) => {
			reviewId = ' ';
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews`)
				.set(setData)
		...
		test('should return invalid status if page is not number', (done) => {
			...
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews?page=${searchField.page}`)
				.set(setData)
				.expect(500, done);
		});
		...
		test('should return invalid status if limit is not number', (done) => {
			...
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews?limit=${searchField.limit}`)
				.set(setData)
				.expect(500, done);
		});
		...
		test('should return reviews if all searchField success get tutor reviews by institute id', (done) => {
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews?page=${searchField.page}&limit=${searchField.limit}`)
				.set(setData)
				.expect(200)
				.end((err, res) => {
					if (err) return done(err);
		...
		test('should return reviews if page success get tutor reviews by institute id', (done) => {
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews?page=${searchField.page}`)
				.set(setData)
				.expect(200)
		...
		test('should return reviews if limit success get tutor reviews by institute id', (done) => {
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews?limit=${searchField.limit}`)
				.set(setData)
				.expect(200)
		...
		test('should return reviews if no searchField success get tutor reviews by institute id', (done) => {
			request
				.get(`/v1/admins/reviews/institute/${reviewId}/tutor-reviews`)
				.set(setData)
				.expect(200)
...
export default getTutorReviewsByInstituteIdTest;
