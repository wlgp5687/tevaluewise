...
const deleteInstituteRegion = () => {
	describe('DELETE /v1/admins/institutes/:institute_id/region', () => {
		...
		test('should return invalid status if instituteId is null', (done) => {
			instituteId = null;
			request
				.delete(`/v1/admins/institutes/${instituteId}/region`)
				.set(setData)
				.expect(500, done);
		});
		...
		test('should return null if success delete institute region', (done) => {
			request
				.delete(`/v1/admins/institutes/${instituteId}/region`)
				.set(setData)
				.expect(200)
...
export default deleteInstituteRegion;
